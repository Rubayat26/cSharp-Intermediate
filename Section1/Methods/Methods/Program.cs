...
namespace Methods
{
    class Program
    {
        ...
        static void UseParams()
        {
            ...
            Console.WriteLine(calculator.Add(new int[] { 1, 2, 3, 4, 5 }));  //because of the params method we can just write the code like above 
                                                                            //add method otherwise we would have to use this line
